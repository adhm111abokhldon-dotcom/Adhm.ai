  ...
  return (
    ...
    >
      <div
        ...
        className={`pointer-events-none blur-2xl rounded-full bg-linear-to-r from-blue-500 to-purple-500
         via-indigo-500 w-75
      h-75 absolute z-0 transition-opacity duration-500 mix-blend-lighten ${visible ? "opacity-70" : "opacity-0"}`}
      />
      <div
